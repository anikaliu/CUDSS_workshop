...
`%>%`  this simbol is called "pipe".It is a useful way to pass information from one function to the following one. In the previous case I asked to read the bd_fat_df and then to filter out the rows that have a value in the column "age" of 40 y.o. or below.
...
```
__Question:__ What other function we could have used intsted of `summarise` in this example?
...
For this practical session we have downloaded a dataset from the [TidyTuesday commnunity](https://www.tidytuesday.com/). It is a dataset about password and their security with some features related to the password.
