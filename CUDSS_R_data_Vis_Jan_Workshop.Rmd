...
R has a lot of visualization packages, every one has some advantages or may be more helpful to some kind of plot then others. ggplot is a quite versatile package to visualize data, still part of the tidyverse. The strength of tidyverse is in its grammar, quite standard for all the plots and the possibility to personalise the plot quite a lot. Having a final picture, clean a pubblication grade.
...
cor(bd_fat_df_BMI, body_fat_df_over_age_height$percent.fat)
